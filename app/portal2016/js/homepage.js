                ...
                if (data.url.length > 0) { //hay link a publicar
                    if (data.url.length === 1) {
                        $("#site-header").prepend(
                            ...
                            "<div class='container'>" +
                            "<div class='' style='width:100%;text-align:center;height:90px;'>" +
                            "<div class='' style='padding-top: 40px;'><span class='icon-right'> </span> <span style='text-transform:uppercase;font-weight:bold'>" + data.url[0].titulo + "</span></div>" +
                            "</div>" +
                            "</div>" +
                            "</a>");
                    }
